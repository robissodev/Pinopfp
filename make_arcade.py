...
BTN_Y = make_mat("btn_yellow", (0.97, 0.88, 0.55), rough=0.6, coat=1.0, transmission=1.0)
BTN_M = make_mat("btn_magenta", (0.98, 0.6, 0.8), rough=0.6, coat=1.0, transmission=1.0)
BTN_G = make_mat("btn_green", (0.6, 0.98, 0.72), rough=0.6, coat=1.0, transmission=1.0)
