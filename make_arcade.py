...
BTN_Y = make_mat("btn_yellow", (0.94, 0.76, 0.05), rough=0.15, coat=1.0, emission=1.2)
BTN_M = make_mat("btn_magenta", (0.95, 0.14, 0.55), rough=0.15, coat=1.0, emission=1.2)
BTN_G = make_mat("btn_green", (0.13, 0.95, 0.35), rough=0.15, coat=1.0, emission=1.2)
