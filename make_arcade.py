...
BTN_Y = make_mat("btn_yellow", (1.0, 0.72, 0.0), rough=0.6, coat=0.1, emission=0.45)
BTN_M = make_mat("btn_magenta", (1.0, 0.04, 0.5), rough=0.6, coat=0.1, emission=0.45)
BTN_G = make_mat("btn_green", (0.02, 1.0, 0.22), rough=0.6, coat=0.1, emission=0.45)
