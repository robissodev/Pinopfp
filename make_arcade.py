...
BTN_Y = make_mat("btn_yellow", (0.94, 0.76, 0.05), rough=0.45, coat=0.25, emission=0.7)
BTN_M = make_mat("btn_magenta", (0.95, 0.14, 0.55), rough=0.45, coat=0.25, emission=0.7)
BTN_G = make_mat("btn_green", (0.13, 0.95, 0.35), rough=0.45, coat=0.25, emission=0.7)
LAMP_Y = make_mat("lamp_yellow", (1.0, 0.85, 0.12), emission=2.6)
LAMP_M = make_mat("lamp_magenta", (1.0, 0.2, 0.6), emission=2.6)
LAMP_G = make_mat("lamp_green", (0.2, 1.0, 0.4), emission=2.6)
